    ...
    <div class="navbar navbar-fixed"> 
        <nav class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-dark gradient-45deg-indigo-purple no-shadow">
            ...
            <ul class="navbar-list right">
                ...
                <li><a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);" data-target="profile-dropdown"><i class="material-icons">face</i></a></li>
                <!-- <li><a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);" data-target="profile-dropdown"><span class="avatar-status avatar-online"><img src="{{ Gravatar::get(Auth::user()->email) }}" alt="avatar"><i></i></span></a></li> -->
            </ul>
            ...
            <ul class="dropdown-content" id="profile-dropdown">
                <li><a class="grey-text text-darken-1" href="{{ route('backend::profile') }}"><i class="material-icons">person_outline</i> Profile</a></li>
                <li>
                    <a href="{{ url('/logout') }}" class="grey-text text-darken-1" id="logout"
