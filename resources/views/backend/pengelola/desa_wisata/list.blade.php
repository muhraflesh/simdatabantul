...
@section('breadcrumbs')
    {!! Breadcrumbs::render('list_pengelola_desa_wisata') !!}
@endsection

@section('action')
<div class="col s2 m6 l6">
    <a class="btn waves-effect waves-light breadcrumbs-btn right" href="{{ route('backend::pengguna.create') }}?tipe=desa_wisata">
...
<!-- <div class="col s2 m6 l6">
    ...
    <ul class="dropdown-content" id="dropdown1" tabindex="0">
        <li tabindex="0">
            <a class="grey-text text-darken-2" href="{{ route('backend::pengelola.desa_wisata.create') }}">
                Tambah Data
            </a>
        </li>
    ...
    <div class="col s12 m12 l12">
        <div id="responsive-table" class="card card card-default scrollspy">
            <div class="card-content">
                ...
                @endif
                <form class="col s12" action="{{ route('backend::pengelola.desa_wisata.index') }}" method="GET">
                    <div class="row">
