...
@section('breadcrumbs')
    {!! Breadcrumbs::render('list_master_desa_wisata') !!}
@endsection

@section('action')
<div class="col s2 m6 l6">
    <a class="btn dd-settings waves-effect waves-light breadcrumbs-btn right" href="{{ route('backend::master.desa_wisata.create') }}">
...
<!-- <div class="col s2 m6 l6">
    ...
    <ul class="dropdown-content" id="dropdown1" tabindex="0">
        <li tabindex="0">
            <a class="grey-text text-darken-2" href="{{ route('backend::master.desa_wisata.create') }}">
                Tambah Data
            </a>
        </li>
    ...
    <div class="col s12 m12 l12">
        <div id="responsive-table" class="card card card-default scrollspy">
            <div class="card-content">
                ...
                @endif
                <form class="col s12" action="{{ route('backend::master.desa_wisata.index') }}" method="GET">
                    <div class="row">
            ...
            <div class="row">
                ...
                <table class="responsive-table">
                    ...
                    <tr>
                        ...
                        <th data-field="kelurahan">Kelurahan</th>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <ul id='dd{{ $no }}' class='dropdown-content'>
                                    ...
                                    <li>
                                        <a href="{{ route('backend::master.desa_wisata.edit', ['id' => $res->id]) }}">
...
function deleteData(id){
    console.log(id);
    dataHtml = "<form method=\"POST\" action=\"{{ url('backend/master/desa_wisata') }}/"+id+"/delete\" accept-charset=\"UTF-8\">";
