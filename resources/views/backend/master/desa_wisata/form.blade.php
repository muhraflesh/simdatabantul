...
<div class="col m12">
    ...
    <div class="input-field col s12">
        ...
        <a href="{{ route('backend::master.desa_wisata.index') }}" class="btn waves-effect waves-light left" role="button">Batal
    ...
    <!-- <div class="form-group">
        ...
        <a href="{{ route('backend::master.desa_wisata.index') }}" class="btn btn-primary btn-sm" role="button">Batal</a>
    </div> -->
</div>
