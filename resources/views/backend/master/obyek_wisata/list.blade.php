...
@section('breadcrumbs')
    {!! Breadcrumbs::render('list_master_obyek_wisata') !!}
@endsection

@section('action')
<div class="col s2 m6 l6">
    <a class="btn dd-settings waves-effect waves-light breadcrumbs-btn right" href="{{ route('backend::master.obyek_wisata.create') }}">
...
<!-- <div class="col s2 m6 l6">
    ...
    <ul class="dropdown-content" id="dd-1" tabindex="0">
        <li tabindex="0">
            <a class="grey-text text-darken-2" href="{{ route('backend::master.obyek_wisata.create') }}">
                Tambah Data
            </a>
        </li>
    ...
    <div class="col s12 m12 l12">
        <div id="responsive-table" class="card card card-default scrollspy">
            <div class="card-content">
                ...
                @endif
                <form class="col s12" action="{{ route('backend::master.obyek_wisata.index') }}" method="GET">
                    <div class="row">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <ul id='dd{{ $no }}' class='dropdown-content'>
                                    ...
                                    <li>
                                        <a href="{{ route('backend::master.obyek_wisata.edit', ['id' => $res->id]) }}">
...
<div id="lihatDetail" class="modal">
    <div class="modal-content">
    <div class="card-content">
          <h4 class="card-title">Obyek Wisata</h4>
          <form class="col s12">
            <div class="row">
              <div class="input-field col s12">
