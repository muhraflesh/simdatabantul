...
@section('breadcrumbs')
    {!! Breadcrumbs::render('list_master_jenis_kamar') !!}
@endsection

@section('action')
<div class="col s2 m6 l6">
    <a class="btn dd-settings waves-effect waves-light breadcrumbs-btn right" href="{{ route('backend::master.jenis_kamar.create') }}">
...
<!-- <div class="col s2 m6 l6">
    ...
    <ul class="dropdown-content" id="dd-1" tabindex="0">
        <li tabindex="0">
            <a class="grey-text text-darken-2" href="{{ route('backend::master.jenis_kamar.create') }}">
                Tambah Data
            </a>
        </li>
    ...
    <div class="col s12 m12 l12">
        <div id="responsive-table" class="card card card-default scrollspy">
            <div class="card-content">
                ...
                @endif
                <form class="col s12" action="{{ route('backend::master.jenis_kamar.index') }}" method="GET">
                    <div class="row">
                        <div class="input-field col m4 s6">
                            <input type="text" name="nama" value="{{ \Request::get('nama') }}" class="form-control form-control-sm" placeholder="Jenis Kamar" />
                        </div>
            ...
            <div class="row">
                ...
                <table class="responsive-table">
                    ...
                    <tr>
                        ...
                        <th data-field="jenis">Jenis Kamar</th>
                        <th data-field="harga">Harga Per Malam</th>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <ul id='dd{{ $no }}' class='dropdown-content'>
                                    ...
                                    <li>
                                        <a href="{{ route('backend::master.jenis_kamar.edit', ['id' => $res->id]) }}">
...
function deleteData(id){
    console.log(id);
    dataHtml = "<form method=\"POST\" action=\"{{ url('backend/master/jenis_kamar') }}/"+id+"/delete\" accept-charset=\"UTF-8\">";
  ...
  function lihatData(data){
    ...
    console.log(obj);
    $('#jenis').val(obj.jenis_kamar);
    $('#harga').val(obj.harga_permalam);
    var ket = obj.keterangan.replace(/(<([^>]+)>)/ig,"");
    $('#keterangan').val(ket);
...
<div id="lihatDetail" class="modal">
    <div class="modal-content">
    <div class="card-content">
          <h4 class="card-title">Kamar Hotel</h4>
          <form class="col s12">
            <div class="row">
              <div class="input-field col s12">
                <input id="jenis" type="text" readonly disabled placeholder="Jenis Kamar">
                <label for="jenis">Jenis Kamar</label>
              </div>
            </div>
            <div class="row">
              <div class="input-field col s12">
                <textarea id="keterangan" style="height: 45px;" class="materialize-textarea" readonly disabled placeholder="Alamat"></textarea>
                <label for="keterangan">Keterangan</label>
              </div>
            </div>
            <div class="row">
              <div class="input-field col s12">
                <input id="harga" type="text" readonly disabled placeholder="0">
