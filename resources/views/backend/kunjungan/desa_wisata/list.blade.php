...
<div class="col s2 m6 l6">
    <a class="btn waves-effect waves-light breadcrumbs-btn right" href="{{ route('backend::kunjungan.desa_wisata.create', ['tipe'=>$tipe_wisata]) }}">
    ...
    <div class="col s12 m12 l12">
        <div id="responsive-table" class="card card card-default scrollspy">
            <div class="card-content">
                ...
                <form class="col s12" action="{{ route('backend::kunjungan.desa_wisata.index', ['tipe'=>$tipe_wisata]) }}" method="GET">
                    <div class="row">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <ul id='dropdown{{ $no }}' class='dropdown-content'>
                                    ...
                                    <li>
                                        <a href="{{ route('backend::kunjungan.desa_wisata.edit', ['tipe'=>$tipe_wisata, 'id' => $res->id]) }}">
...
function deleteData(id){
    console.log(id);
    dataHtml = "<form method=\"POST\" action=\"{{ url('backend/kunjungan/desa_wisata/'.$tipe_wisata) }}/"+id+"/delete\" accept-charset=\"UTF-8\">";
