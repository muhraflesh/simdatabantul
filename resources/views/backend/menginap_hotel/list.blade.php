...
<div class="col s2 m6 l6">
    <a class="btn waves-effect waves-light breadcrumbs-btn right" href="{{ route('backend::menginap_hotel.create', ['tipe'=>$tipe_wisata]) }}">
...
<!-- <div class="col s2 m6 l6">
    ...
    <ul class="dropdown-content" id="dropdown1" tabindex="0">
        <li tabindex="0">
            <a class="grey-text text-darken-2" href="{{ route('backend::menginap_hotel.create', ['tipe'=>$tipe_wisata]) }}">
                Tambah Data
            </a>
        </li>
    ...
    <div class="col s12 m12 l12">
        <div id="responsive-table" class="card card card-default scrollspy">
            <div class="card-content">
                ...
                <form class="col s12" action="{{ route('backend::menginap_hotel.index', ['tipe'=>$tipe_wisata]) }}" method="GET">
                    <div class="row">
                        ...
                        <div class="input-field col m3 s6">
                            <select name="jenis">
                                <option{{ \Request::get('jenis')==''? " selected" : "" }} value="">Semua</option>
                                <option{{ \Request::get('jenis')=='bintang'? " selected" : "" }} value="bintang">Bintang</option>
                                <option{{ \Request::get('jenis')=='nonbintang'? " selected" : "" }} value="nonbintang">Non Bintang</option>
                            </select>
                        </div>
            ...
            <div class="row">
                ...
                <table class="responsive-table">
                    ...
                    <tr>
                        ...
                        <th data-field="total">Total Harga</th>
                        @if(\Auth::user()->hasRole('superadmin'))
                        <th data-field="hotel">Nama Hotel</th>
                        @endif
                        <th data-field="kamar">Jenis Kamar</th>
                    ...
                    <?php $no=1;?>
                        ...
                        <tr>
                            ...
                            @if(\Auth::user()->hasRole('superadmin'))
                            <td>
                                {{ $res->kamar->hotel->nama_hotel }}
                            </td>
                            @endif
                            <td>
                                {{ $res->kamar->jenis_kamar }}
                            </td>
                            <td>
                                ...
                                <ul id='dropdown{{ $no }}' class='dropdown-content'>
                                    ...
                                    <li>
                                        <a href="{{ route('backend::menginap_hotel.edit', ['tipe'=>$tipe_wisata, 'id' => $res->id]) }}">
...
function deleteData(id){
    console.log(id);
    dataHtml = "<form method=\"POST\" action=\"{{ url('backend/menginap_hotel/'.$tipe_wisata) }}/"+id+"/delete\" accept-charset=\"UTF-8\">";
