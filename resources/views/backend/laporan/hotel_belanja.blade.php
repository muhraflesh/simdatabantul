    ...
    <div class="col s12 m12 l12">
        <div id="responsive-table" class="card card card-default scrollspy">
            <div class="card-content">
                ...
                <form class="col s12" action="{{ route('backend::laporan.hotel_belanja') }}" method="GET">
                    <div class="row">                     
                ...
                <table class="responsive-table">
                    <thead>
                        <tr>
                            ...
                            <th data-field="nama" rowspan="2">Nama Hotel</th>
                            @endif
                            <th data-field="jenis" rowspan="2">Jenis Belanja</th>
                        ...
                        <tr>
                            ...
                            @elseif(\Request::get("waktuTipe")=="mingguan")
                                ...
                                $weekNumber = App\Utils\LaporanDownload\HotelBelanja::weekOfMonth($lastDate);
                                @endphp
                    ...
                    <tr>
                        ...
                        $wisatawan = App\Utils\LaporanDownload\HotelBelanja::getStatistikBelanja($res->hotel_id, $tipe, $waktu);
                        @endphp
                        @foreach($wisatawan['kuliner'] as $wm)
                        <td>{{ $wm['wisman'] }}</td>
                        @endforeach
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td rowspan="3">Transportasi</td>
                        <td>Wisman</td>
                        @foreach($wisatawan['transportasi'] as $wm)
                        <td>{{ $wm['wisman'] }}</td>
                        @endforeach
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td rowspan="3">Oleh-Oleh</td>
                        <td>Wisman</td>
                        @foreach($wisatawan['oleholeh'] as $wm)
                        <td>{{ $wm['wisman'] }}</td>
                        @endforeach
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td rowspan="3">Paket Wisata</td>
                        <td>Wisman</td>
                        @foreach($wisatawan['paketwisata'] as $wm)
                        <td>{{ $wm['wisman'] }}</td>
                        @endforeach
                    </tr>
                    <tr>
