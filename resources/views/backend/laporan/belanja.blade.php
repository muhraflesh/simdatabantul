    ...
    <div class="col s12 m12 l12">
        <div id="responsive-table" class="card card card-default scrollspy">
            <div class="card-content">
                ...
                <form class="col s12" action="{{ route('backend::laporan.belanja') }}" method="GET">
                    <div class="row">                     
                ...
                <table class="responsive-table">
                    <thead>
                        <tr>
                            ...
                            <th data-field="nama" rowspan="2">Nama Desa Wisata</th>
                            @endif
                            ...
                            <th data-field="tanggal" style="text: center;" colspan="29">Tanggal</th>
                    ...
                    <tr>
                        ...
                        $wisatawan = App\Utils\LaporanDownload\Belanja::getStatistikBelanja($res->wisata_id, $tipe, $waktu);
                        @endphp
