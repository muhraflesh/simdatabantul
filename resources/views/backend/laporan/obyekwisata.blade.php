    ...
    <div class="col s12 m12 l12">
        <div id="responsive-table" class="card card card-default scrollspy">
            <div class="card-content">
                ...
                <form class="col s12" action="{{ route('backend::laporan.obyek') }}" method="GET">
                    <div class="row">                     
                ...
                <table class="responsive-table">
                    <thead>
                        <tr>
                            ...
                            <th data-field="nama" rowspan="2">Obyek Wisata</th>
                            @endif
                    ...
                    <tr>
                        ...
                        $wisatawan = App\Utils\LaporanDownload\ObyekWisata::getStatistikObyekWisata($res->wisata_id, $tipe, $waktu);
                        @endphp
