    ...
    <div class="col s12 m12 l12">
        <div id="responsive-table" class="card card card-default scrollspy">
            <div class="card-content">
                ...
                <form class="col s12" action="{{ route('backend::laporan.hotel') }}" method="GET">
                    <div class="row">                     
                ...
                <table class="responsive-table">
                    <thead>
                        <tr>
                            ...
                            <th data-field="lama" rowspan="2">Lama dan Jumlah</th>
                    ...
                    <tr>
                        ...
                        $wisatawan = App\Utils\LaporanDownload\Hotel::getJumlahPenginapan($res->hotel_id, $tipe, $waktu);
                        @endphp
                        @foreach($wisatawan['mancanegara'] as $wm)
                        <td>{{ $wm['jumlah_orang'] }}</td>
                        @endforeach
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        @foreach($wisatawan['nusantara'] as $wm)
                        <td>{{ $wm['jumlah_orang'] }}</td>
                        @endforeach
                    </tr>
                    <tr>
