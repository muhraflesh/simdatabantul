    ...
    <div class="col s12 m12 l12">
        <div id="responsive-table" class="card card card-default scrollspy">
            <div class="card-content">
                ...
                <form class="col s12" action="{{ route('backend::laporan.homestay') }}" method="GET">
                    <div class="row">                     
                ...
                <table class="responsive-table">
                    <thead>
                        <tr>
                            ...
                            @endif
                            <th data-field="homestay" rowspan="2">Homestay</th>
                            <th data-field="jmlkamar" rowspan="2">Jumlah Kamar</th>
                            <th data-field="pemilik" rowspan="2">Pemilik</th>
                            <th data-field="lj" rowspan="2">Lama & Jumlah</th>
                    ...
                    <tr>
                        ...
                        @endif
                        <td rowspan="6">
                            {{ $res->akomodasi->nama_akomodasi }}
                        </td>
                        <td rowspan="6">
                            {{ $res->akomodasi->jumlah_kamar }}
                        </td>
                        <td rowspan="6">
                        ...
                        $wisatawan = App\Utils\LaporanDownload\Homestay::getStatistikHomestay($res->akomodasi_id, $tipe, $waktu);
                        @endphp
                        @foreach($wisatawan['lama'] as $wm)
                        <td>{{ $wm['mancanegara'] }}</td>
                        @endforeach
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        @foreach($wisatawan['jumlah_orang'] as $wm)
                        <td>{{ $wm['mancanegara'] }}</td>
                        @endforeach
                    </tr>
                    <tr>
