...
<div class="col s2 m6 l6">
    <a class="btn waves-effect waves-light breadcrumbs-btn right" href="{{ route('backend::belanja.create', ['tipe'=>$tipe_wisata]) }}">
...
<!-- <div class="col s2 m6 l6">
    ...
    <ul class="dropdown-content" id="dropdown1" tabindex="0">
        <li tabindex="0">
            <a class="grey-text text-darken-2" href="{{ route('backend::belanja.create', ['tipe'=>$tipe_wisata]) }}">
                Tambah Data
            </a>
        </li>
    ...
    <div class="col s12 m12 l12">
        <div id="responsive-table" class="card card card-default scrollspy">
            <div class="card-content">
                ...
                <form class="col s12" action="{{ route('backend::belanja.index', ['tipe'=>$tipe_wisata]) }}" method="GET">
                    <div class="row">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <ul id='dropdown{{ $no }}' class='dropdown-content'>
                                    ...
                                    <li>
                                        <a href="{{ route('backend::belanja.edit', ['tipe'=>$tipe_wisata, 'id' => $res->id]) }}">
...
function deleteData(id){
    console.log(id);
    dataHtml = "<form method=\"POST\" action=\"{{ url('backend/belanja/'.$tipe_wisata) }}/"+id+"/delete\" accept-charset=\"UTF-8\">";
