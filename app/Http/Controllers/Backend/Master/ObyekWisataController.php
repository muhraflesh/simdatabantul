...
class ObyekWisataController extends Controller{
    ...
    public function store(Request $request){
        ...
        $mimeList = array("jpeg", "jpg", "png", "svg");
        ...
        if(!empty($request->foto)){
            ...
            foreach($request->foto as $foto){
                if(!empty($foto['url_foto'])) {
                    if (!in_array(strtolower($foto['url_foto']->getClientOriginalExtension()), $mimeList)) {
                        $checkCounter = 1;
                    }
                }
            }
            ...
            if ($checkCounter == 0) {
                ...
                ->withErrors(
                    [
                        'url_foto' => 'Tipe file yang anda masukkan tidak sesuai',
                    ]
                );
            }
