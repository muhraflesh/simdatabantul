...
class DesaWisataController extends Controller{
    ...
    public $routePath = "backend::kunjungan.desa_wisata";
    public $prefix = "backend.kunjungan.desa_wisata";

    function __construct(){
        $this->prefix = 'backend.kunjungan.desa_wisata';
    }
    ...
    public function index(Request $request, $tipe){
        $data['page_name'] = "Kunjungan Desa Wisata ".ucwords($tipe);
        $data['page_description'] = "Data Kunjungan Desa Wisata ".ucwords($tipe);
    ...
    public function create(Request $request, $tipe){
        $data['page_name'] = "Kunjungan Desa Wisata ".ucwords($tipe);
        $data['page_description'] = "Buat kunjungan desa wisata baru";
    ...
    public function store(Request $request, $tipe){
        ...
        // $gambar->move(public_path("/uploads/kunjungan/desa_wisata/"), $gambarName);
        // $request->request->add([
        //     'file'     => 'uploads/kunjungan/desa_wisata/'.$gambarName
        // ]);
        ...
        if(!empty($request->foto)){
            foreach($request->foto as $foto){
                ...
                if(!empty($foto['url_foto'])){
                    ...
                    $gambar->move(public_path("/uploads/kunjungan/desa_wisata/".$judul."/"), $gambarName);

                    $image_path = app_path("uploads/kunjungan/desa_wisata/".$judul."/".$foto['url_foto']);
                    $filename = 'uploads/kunjungan/desa_wisata/'.$judul.'/'.$gambarName;
                }else{
    ...
    public function edit(Request $request, $tipe, $id){
        ...
        $parse['page_name'] = "Ubah Kunjungan Desa Wisata ".ucwords($tipe);
        $parse['page_description'] = "Ubah Kunjungan Desa Wisata ".ucwords($tipe);
        $parse['data'] = $data;
